...
if __name__ == "__main__":
    ...
    run_id = "selector_run_24.00"
    wandb.login(key=os.environ["WANDB_KEY"])
    logger = wandb.init(dir="./wandb_store",
                        name="Selector_Run_24.00",
                        project="Opti",
                        entity="kaiyotech",
                        id=run_id,
                        config=config,
    ...
    initial_selector_skip_k = 0.0002  # initial 6 seconds
