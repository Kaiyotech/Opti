                ...
                self.setters.append(
                    WeightedSampleSetter(
                        (
                            ...
                            AugmentSetter(GroundAirDribble()),
                            AugmentSetter(WallDribble()),
                            AugmentSetter(WallDribble(speed_min=1700, speed_max=1900, max_rand_z=300)),
                            AugmentSetter(ReplaySetter(low_flip_reset_replays[i], random_boost=True)),
                            AugmentSetter(ReplaySetter(wall_flip_reset_replays[i], random_boost=True)),

                        ),
                        (0.025, 0.1, 0.1, 0.05, 0.1, 0.25, 0.275, 0.1)
                    )
                )
        elif mode == "selector":
            for i in range(3):
                    ...
                    WeightedSampleSetter(
                        (
                            ...
                            AugmentSetter(ReplaySetter(double_tap_replays[0], defender_front_goal_weight=0,
                                                       random_boost=True, expand_shrink_cars=True),
                                          ),
                        ...
                        (0.12, 0.02, 0.14, 0.04,  # default, ko_repl, repl, aerial
                         0.05, 0, 0, 0.04,  # ground-air, rand grouwnd, rand air, flip reset
                         0.12, 0.12, 0.1, 0,  # wall dribble, wall flip reset, fast-low wall, low flip reset
                         0.04, 0.05, 0.04, 0.02,  # ceiling, air dribble, pinch, team pinch
                         0.02, 0, 0.08, 0)  # full pinch, ground dribble, double-tap, easy_doubletap
                        # # test
            ...
            for i in range(3):
                self.setters.append(
                    WeightedSampleSetter(
                        (
                            AugmentSetter(
                                ReplaySetter(aerial_replays[i], random_boost=True, remove_defender_weight=0.1)),
                            AugmentSetter(
                                ReplaySetter(flip_reset_replays[i], random_boost=True, remove_defender_weight=0.1)),
                            AugmentSetter(
                                ReplaySetter(ceiling_replays[i], random_boost=True, remove_defender_weight=0.1)),
                            AugmentSetter(
                ...
                self.setters.append(
                    WeightedSampleSetter(
                        (
                            ...
                            AugmentSetter(WallDribble()),
                            AugmentSetter(WallDribble(speed_min=1450, speed_max=1700, max_rand_z=300)),
